...
export const interiorCategories = [
  ...
  { id: "bedroom" as const, label: "Yatak Odası" },
  { id: "bath" as const, label: "Banyo" },
  { id: "entry" as const, label: "Antre" },
  { id: "balcony" as const, label: "Balkon" },
];
...
export const interiorViews = [
  {
    ...
    alt: "Terra Bağlıca salon görünümü",
    title: "Salon",
    category: "living" as const,
  },
  {
    id: "int-02",
    src: "/images/interior/02-salon-2.jpg",
    alt: "Terra Bağlıca salon perspektifi",
    title: "Salon",
    category: "living" as const,
  },
  {
    id: "int-03",
    src: "/images/interior/03-salon-3.jpg",
    alt: "Terra Bağlıca salon genel görünüm",
    title: "Salon",
    category: "living" as const,
  },
  {
    id: "int-04",
    src: "/images/interior/04-salon-4.jpg",
    alt: "Terra Bağlıca salon ve yaşam alanı",
    title: "Salon",
    category: "living" as const,
  },
  {
    id: "int-05",
    src: "/images/interior/05-oturma.jpg",
    alt: "Terra Bağlıca oturma odası",
    title: "Oturma Odası",
    category: "living" as const,
  },
  {
    id: "int-06",
    src: "/images/interior/06-oturma-2.jpg",
    alt: "Terra Bağlıca oturma odası perspektifi",
    title: "Oturma Odası",
    category: "living" as const,
  },
  {
    id: "int-07",
    src: "/images/interior/07-mutfak.jpg",
    alt: "Terra Bağlıca modern mutfak",
    title: "Mutfak",
    category: "kitchen" as const,
  },
  {
    id: "int-08",
    src: "/images/interior/08-mutfak-2.jpg",
  ...
  {
    id: "int-09",
    src: "/images/interior/09-mutfak-3.jpg",
  ...
  {
    id: "int-10",
    src: "/images/interior/10-mutfak-4.jpg",
    alt: "Terra Bağlıca mutfak perspektifi",
    title: "Mutfak",
    category: "kitchen" as const,
  },
  {
    id: "int-11",
    src: "/images/interior/11-mutfak-5.jpg",
  ...
  {
    id: "int-12",
    src: "/images/interior/12-ebeveyn-yatak.jpg",
    alt: "Terra Bağlıca ebeveyn yatak odası",
    title: "Ebeveyn Yatak Odası",
    category: "bedroom" as const,
  },
  {
    id: "int-13",
    src: "/images/interior/13-ebeveyn-yatak-2.jpg",
    alt: "Terra Bağlıca ebeveyn yatak odası perspektifi",
    title: "Ebeveyn Yatak Odası",
    category: "bedroom" as const,
  },
  {
    id: "int-14",
    src: "/images/interior/14-ebeveyn-yatak-3.jpg",
    alt: "Terra Bağlıca ebeveyn yatak odası detay",
    title: "Ebeveyn Yatak Odası",
    category: "bedroom" as const,
  },
  {
    id: "int-15",
    src: "/images/interior/15-ebeveyn-yatak-4.jpg",
    alt: "Terra Bağlıca ebeveyn yatak odası genel görünüm",
    title: "Ebeveyn Yatak Odası",
    category: "bedroom" as const,
  },
  {
    id: "int-16",
    src: "/images/interior/16-cocuk-odasi.jpg",
    alt: "Terra Bağlıca çocuk odası",
    title: "Çocuk Odası",
    category: "bedroom" as const,
  },
  {
    id: "int-17",
    src: "/images/interior/17-cocuk-odasi-2.jpg",
    alt: "Terra Bağlıca çocuk odası perspektifi",
    title: "Çocuk Odası",
    category: "bedroom" as const,
  },
  {
    id: "int-18",
    src: "/images/interior/18-cocuk-odasi-3.jpg",
    alt: "Terra Bağlıca ikinci çocuk odası",
    title: "Çocuk Odası",
    category: "bedroom" as const,
  },
  {
    id: "int-19",
    src: "/images/interior/19-cocuk-odasi-4.jpg",
    alt: "Terra Bağlıca çocuk odası detay görünümü",
    title: "Çocuk Odası",
    category: "bedroom" as const,
  },
  {
    id: "int-20",
    src: "/images/interior/20-genel-banyo.jpg",
    alt: "Terra Bağlıca genel banyo",
    title: "Genel Banyo",
    category: "bath" as const,
  },
  {
    id: "int-21",
    src: "/images/interior/21-genel-banyo-2.jpg",
    alt: "Terra Bağlıca genel banyo perspektifi",
    title: "Genel Banyo",
    category: "bath" as const,
  },
  {
    id: "int-22",
    src: "/images/interior/22-antre.jpg",
  ...
  {
    id: "int-23",
    src: "/images/interior/23-antre-2.jpg",
    alt: "Terra Bağlıca antre ve vestiyer",
    title: "Antre",
    category: "entry" as const,
  },
  {
    id: "int-24",
    src: "/images/interior/24-balkon.jpg",
    alt: "Terra Bağlıca balkon görünümü",
    title: "Balkon",
    category: "balcony" as const,
  },
  {
    id: "int-25",
    src: "/images/interior/25-balkon-2.jpg",
    alt: "Terra Bağlıca balkon perspektifi",
    title: "Balkon",
    category: "balcony" as const,
  },
];
