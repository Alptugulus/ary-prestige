...
import { floorPlanTypes, floorPlanPdf, siteConfig } from "@/lib/data";
import { cn } from "@/lib/utils";

export function FloorPlanViewer() {
  const plan =
    floorPlanTypes.find((t) => t.id === "full") ?? floorPlanTypes[0];
    ...
    <>
      <div className="space-y-6">
        <div className="flex flex-wrap items-center justify-end gap-2">
          ...
          <a
            href={floorPlanPdf}
            download="Terra-Baglica-Kat-Plani.pdf"
              ...
              >
                ...
                >
                  <Image
                    key={plan.image}
                    src={plan.image}
                    alt={`${siteConfig.name} ${plan.label} kat planı`}
                    width={1190}
                    height={1546}
          ...
          >
            <div className="flex items-center justify-between p-4 md:p-6 border-b border-white/5">
              <div>
                ...
                <p className="text-white text-sm mt-1">{plan.netArea} net</p>
              </div>
              <button
